<template>
    <div>
        ...
        <el-card>
            ...
            <el-table ref="userListTable" :data="userList" @current-change="tableSelectChange"
            highlight-current-row stripe border style="width: 100%">
                <!-- <el-row>
                    <el-col :span="4">
            ...
            <el-row type="flex">
                <el-col :span="10">
                <el-pagination @size-change="tableSizeChange" @current-change="tablePageChange"
                ...
                <el-col :span="3">
                    <el-button @click="addUser" type="primary" icon="el-icon-plus">Add</el-button>
                </el-col>
                <el-col :span="3">
                    <el-button @click="deleteUser" :disabled="buttonDisabled" type="warning" icon="el-icon-delete">Delete</el-button>
                </el-col>
                <el-col :span="3">
                    <el-button @click="editUser" :disabled="buttonDisabled" type="danger" icon="el-icon-edit">Edit</el-button>
                </el-col>
            </el-row>
        </el-card>
        <!-- Add user dialog. -->
        <el-dialog title="Add a new user" :visible.sync="addUserVisible" width="50%">
            <el-form ref="addUserForm" :model="addUserForm" :rules="addUserFormRules" status-icon label-width="125px">
                <el-form-item label="Username" prop="username">
                    <el-input type="text" v-model="addUserForm.username" autosize autocomplete="off" prefix-icon="el-icon-user"></el-input>
                </el-form-item>
                <!-- The Prop Value must be in the v-model defines. -->
                <el-form-item label="Real Name" prop="realName">
                    <el-input type="text" v-model="addUserForm.realName" autosize autocomplete="off" prefix-icon="el-icon-user-solid"></el-input>
                </el-form-item>
                <el-form-item label="E-mail" prop="email">
                    <el-input type="text" v-model="addUserForm.email" autosize autocomplete="off" prefix-icon="el-icon-message"></el-input>
                </el-form-item>
                <el-form-item label="Phone Number" prop="phoneNumber">
                    <el-input type="text" v-model.number="addUserForm.phoneNumber" autosize autocomplete="off" prefix-icon="el-icon-phone-outline"></el-input>
                </el-form-item>
                <el-form-item label="Password" prop="password">
                    <el-input type="password" v-model="addUserForm.password" autosize autocomplete="off" prefix-icon="el-icon-edit"></el-input>
                </el-form-item>
                <el-form-item label="Repeat" prop="repeatPassword">
                    <el-input type="password" v-model="addUserForm.repeatPassword" autosize autocomplete="off" prefix-icon="el-icon-edit-outline"></el-input>
                </el-form-item>
            </el-form>
            <span slot="footer">
                <el-button @click="addUserDialogCancel">Cancel</el-button>
                <el-button type="primary" @click="addUserDialogCommit">Commit</el-button>
            </span>
        </el-dialog>
        <!-- Edit user dialog. -->
        <el-dialog title="Edit user profile" :visible.sync="editUserVisible" width="50%">
            <el-form ref="editUserForm" :model="editUserForm" :rules="editUserFormRules" status-icon label-width="125px">
                <el-form-item label="Username">
                    <el-input type="text" v-model="editUserForm.username" autosize disabled prefix-icon="el-icon-user"></el-input>
                </el-form-item>
                <!-- The Prop Value must be in the v-model defines. -->
                <el-form-item label="Real Name">
                    <el-input type="text" v-model="editUserForm.realName" autosize disabled prefix-icon="el-icon-user-solid"></el-input>
                </el-form-item>
                <el-form-item label="E-mail" prop="email">
                    <el-input type="text" v-model="editUserForm.email" autosize autocomplete="off" prefix-icon="el-icon-message"></el-input>
                </el-form-item>
                <el-form-item label="Phone Number" prop="phoneNumber">
                    <el-input type="text" v-model.number="editUserForm.phoneNumber" autosize autocomplete="off" prefix-icon="el-icon-phone-outline"></el-input>
                </el-form-item>
                <el-form-item label="Password" prop="password">
                    <el-input type="password" v-model="editUserForm.password" autosize autocomplete="off" prefix-icon="el-icon-edit"></el-input>
                </el-form-item>
                <el-form-item label="Repeat" prop="repeatPassword">
                    <el-input type="password" v-model="editUserForm.repeatPassword" autosize autocomplete="off" prefix-icon="el-icon-edit-outline"></el-input>
                </el-form-item>
            </el-form>
            <span slot="footer">
                <el-button @click="editUserDialogCancel">Cancel</el-button>
                <el-button type="primary" @click="editUserDialogCommit">Commit</el-button>
            </span>
        </el-dialog>
    </div>
</template>
...
export default {
    ...
    data: function (){
        ...
        return {
            ...
            // Make button disable when select nothing.
            buttonDisabled: true,
            quaryString: '',
            pageNumber: 1,
            pageSize: 5
