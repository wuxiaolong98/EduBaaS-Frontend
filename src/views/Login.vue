<template>
    <div>
        <div class="container">
            ...
            <el-form :model="loginForm" :rules="loginFormRules" status-icon ref="loginForm" label-width="100px" class="loginForm">
            <el-form-item label="Username" prop="username">
                <el-input type="text" v-model="loginForm.username" autosize autocomplete="off" prefix-icon="el-icon-user"></el-input>
            </el-form-item>
            <!-- The Prop Value must be in the v-model defines. -->
            <el-form-item label="Password" prop="password">
                <el-input type="password" v-model="loginForm.password" autosize autocomplete="off" prefix-icon="el-icon-edit"></el-input>
            </el-form-item>
            <el-form-item>
                <el-button type="primary" @click="submitForm('loginForm')">Submit</el-button>
                <el-button type="info" @click="resetForm('loginForm')">Reset</el-button>
    ...
    methods: {
        submitForm: function(formName){
            this.$refs[formName].validate( (valid) => {
                if (valid){
                    this.$http.get('/login', this.loginForm)
                    .then( (response) => {
                        ...
                        if (role == 0){
                            this.$router.push('/home/administrator/welcome')
                        } else if (role == 1){
